<template>
    <div class="about-area section-padding">
 		<div class="container">
			<h1 class="h1-titulo" style="padding: 30px;">¿Qué Puedes Hacer Con USSA ?</h1>
 			<div class="row align-items-center">
 				<div class="col-lg-6 col-md-12 col-sm-12">
                    ...
                    <div class="image-one wow fadeInUp" data-wow-delay=".2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp;">
                        <img src="/assets/img/9560814sized.png" alt="">
                    </div>                        
 				...
 				<div class="col-lg-6 col-md-12 col-sm-12">
 					<div class="info-content-area">
 						<div class="section-title">
 							<!---h6>About Us</h6> --->
							 <h2><span class="punto"></span>Interacción automatica</h2>
 						</div>
